...
def import_history(apps, schema_editor):
    ...
    date = datetime.strptime("2015-09-04", "%Y-%m-%d")
    ...
    if Story.objects.filter(key='SRMF-164'): StoryHistory(story=Story.objects.filter(key='SRMF-164')[0],status=Status.objects.get(key='R3 Delivered'),date=date).save()
    if Story.objects.filter(key='SRMF-163'): StoryHistory(story=Story.objects.filter(key='SRMF-163')[0],status=Status.objects.get(key='R3 Validated'),date=date).save()
    if Story.objects.filter(key='SRMF-162'): StoryHistory(story=Story.objects.filter(key='SRMF-162')[0],status=Status.objects.get(key='In Progress'),date=date).save()
    ...
    if Story.objects.filter(key='SRMF-159'): StoryHistory(story=Story.objects.filter(key='SRMF-159')[0],status=Status.objects.get(key='In Progress'),date=date).save()
