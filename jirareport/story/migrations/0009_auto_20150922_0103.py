...
def import_history(apps, schema_editor):
    ...
    date = datetime.strptime("2015-08-21", "%Y-%m-%d")
    ...
    if Story.objects.filter(key='SRMF-117'): StoryHistory(story=Story.objects.filter(key='SRMF-117')[0],status=Status.objects.get(key='Open'),date=date).save()
    ...
    if Story.objects.filter(key='SRMF-113'): StoryHistory(story=Story.objects.filter(key='SRMF-113')[0],status=Status.objects.get(key='Open'),date=date).save()
    ...
    if Story.objects.filter(key='SRMF-78'): StoryHistory(story=Story.objects.filter(key='SRMF-78')[0],status=Status.objects.get(key='Open'),date=date).save()
    ...
    if Story.objects.filter(key='SRMF-59'): StoryHistory(story=Story.objects.filter(key='SRMF-59')[0],status=Status.objects.get(key='Reopened'),date=date).save()
    ...
    if Story.objects.filter(key='SRMF-32'): StoryHistory(story=Story.objects.filter(key='SRMF-32')[0],status=Status.objects.get(key='Open'),date=date).save()
    ...
    if Story.objects.filter(key='SRMF-29'): StoryHistory(story=Story.objects.filter(key='SRMF-29')[0],status=Status.objects.get(key='Open'),date=date).save()
    ...
    if Story.objects.filter(key='SRMF-22'): StoryHistory(story=Story.objects.filter(key='SRMF-22')[0],status=Status.objects.get(key='Open'),date=date).save()
    ...
    if Story.objects.filter(key='SRMF-4'): StoryHistory(story=Story.objects.filter(key='SRMF-4')[0],status=Status.objects.get(key='Open'),date=date).save()

class Migration(migrations.Migration):

    dependencies = [
        ('story', '0008_auto_20150922_0059'),
    ]
