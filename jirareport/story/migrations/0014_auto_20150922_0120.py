...
def import_history(apps, schema_editor):
    ...
    date = datetime.strptime("2015-09-02", "%Y-%m-%d")
    ...
    if Story.objects.filter(key='SRMF-198'): StoryHistory(story=Story.objects.filter(key='SRMF-198')[0],status=Status.objects.get(key='R3 Delivered'),date=date).save()
    if Story.objects.filter(key='SRMF-197'): StoryHistory(story=Story.objects.filter(key='SRMF-197')[0],status=Status.objects.get(key='Blocked'),date=date).save()
    ...
    if Story.objects.filter(key='SRMF-163'): StoryHistory(story=Story.objects.filter(key='SRMF-163')[0],status=Status.objects.get(key='Blocked'),date=date).save()
    if Story.objects.filter(key='SRMF-162'): StoryHistory(story=Story.objects.filter(key='SRMF-162')[0],status=Status.objects.get(key='Blocked'),date=date).save()
    ...
    if Story.objects.filter(key='SRMF-159'): StoryHistory(story=Story.objects.filter(key='SRMF-159')[0],status=Status.objects.get(key='Blocked'),date=date).save()
    ...
    if Story.objects.filter(key='SRMF-4'): StoryHistory(story=Story.objects.filter(key='SRMF-4')[0],status=Status.objects.get(key='REgression'),date=date).save()


class Migration(migrations.Migration):

    dependencies = [
        ('story', '0013_auto_20150922_0115'),
    ]
