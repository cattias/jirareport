...
def import_history(apps, schema_editor):
    date = datetime.strptime("2015-09-29", "%Y-%m-%d")

    Epic.CreateEpicFromExcel('SRMF-1', 'Create a new POD', 'ACS_1.0')
    ...
    Story.CreateHistoryFromExcel('SRMF-12', 'Search logs for OBE flow', 'MNR, admin_services','2 - High Attention','Post incident investigation', 'Open', date)
    Story.CreateHistoryFromExcel('SRMF-13', 'Search logs for Admin portal flow', 'MNR, admin_services','2 - High Attention','Post incident investigation', 'Open', date)
    ...
    Story.CreateHistoryFromExcel('SRMF-15', 'Validate logs search criteria', 'MNR, admin_services','4 - Low','Post incident investigation', 'Open', date)
    ...
    Story.CreateHistoryFromExcel('SRMF-22', 'OTF-SvcBE:Create an instance of a new POD containing it', '','2 - High Attention','Create a new POD', 'R3 Validated', date)
    Story.CreateHistoryFromExcel('SRMF-25', 'JBoss:Create an instance of a new POD', '','2 - High Attention','Create a new POD', 'R3 Validated', date)
    Story.CreateHistoryFromExcel('SRMF-26', 'Apache:Create an instance of a new POD', '','3 - Normal','Create a new POD', 'R3 Validated', date)
    Story.CreateHistoryFromExcel('SRMF-27', 'GQSDaemon:Create an instance of a new POD', 'AHP, CMD, SRO','2 - High Attention','Create a new POD', 'R3 Delivered', date)
    Story.CreateHistoryFromExcel('SRMF-29', 'Logging Pod:Create several instances of a POD containing it', '','2 - High Attention','Create a new POD', 'R3 Validated', date)
    Story.CreateHistoryFromExcel('SRMF-30', 'AcsServer:Create an instance of a new POD', '','2 - High Attention','Create a new POD', 'Partially Validated', date)
    Story.CreateHistoryFromExcel('SRMF-31', 'GQS:Create an instance of a new POD', 'AHP, CMD, SRO','2 - High Attention','Create a new POD', 'R3 Delivered', date)
    Story.CreateHistoryFromExcel('SRMF-32', 'G-ESB:Create an instance of a new POD type', '','2 - High Attention','Create a new POD', 'R3 Validated', date)
    Epic.CreateEpicFromExcel('SRMF-33', 'Deploy a new version of POD', 'ACS_1.0')
    ...
    Epic.CreateEpicFromExcel('SRMF-36', 'Dismantle an existing Izolation Zone', 'ACS_1.0')
    ...
    Story.CreateHistoryFromExcel('SRMF-56', 'Count item in a queue', 'Queues','3 - Normal','Administrate applications queues (LQS/GQS)', 'Open', date)
    ...
    Story.CreateHistoryFromExcel('SRMF-59', 'OTF-SvcBE:Create several instances of a pod containing it', '','2 - High Attention','Create a new POD', 'R3 Validated', date)
    Story.CreateHistoryFromExcel('SRMF-60', 'JBoss:Create several instances of a POD containing it', '','2 - High Attention','Create a new POD', 'R3 Validated', date)
    Story.CreateHistoryFromExcel('SRMF-61', 'RepeatableDaemon:Create several instances of a POD containing it', '','2 - High Attention','Create a new POD', 'R3 Validated', date)
    Story.CreateHistoryFromExcel('SRMF-62', 'UniqueDaemon:Create an instance of a POD containing it', '','2 - High Attention','Create a new POD', 'R3 Validated', date)
    Story.CreateHistoryFromExcel('SRMF-63', 'GQS:Create the POD with several instance', 'AHP, CMD, SRO','2 - High Attention','Create a new POD', 'R3 Delivered', date)
    ...
    Story.CreateHistoryFromExcel('SRMF-89', 'OTF-SvcBE:Application check-out failing', 'AHP, CMD, SRO','2 - High Attention','Create a new POD', 'R3 Delivered', date)
    Story.CreateHistoryFromExcel('SRMF-90', 'Apache:Create several instances of a POD containing it', '','3 - Normal','Create a new POD', 'R3 Validated', date)
    Story.CreateHistoryFromExcel('SRMF-92', 'TimeInitDaemon:Create an instance of a POD containing it', '','2 - High Attention','Create a new POD', 'R3 Validated', date)
    Story.CreateHistoryFromExcel('SRMF-93', 'UniqueDaemon:Create the POD with several instance', '','2 - High Attention','Create a new POD', 'R3 Validated', date)
    ...
    Story.CreateHistoryFromExcel('SRMF-103', 'OTF-SvcBE:Deploy a new version of POD', 'AHP, CMD, SRO','2 - High Attention','Deploy a new version of POD', 'Open', date)
    Story.CreateHistoryFromExcel('SRMF-104', 'JBoss:Deploy a new version of POD', 'AHP, CMD, SRO','2 - High Attention','Deploy a new version of POD', 'Open', date)
    Story.CreateHistoryFromExcel('SRMF-105', 'Apache:Deploy a new version of POD', '','3 - Normal','Deploy a new version of POD', 'R3 Validated', date)
    Story.CreateHistoryFromExcel('SRMF-106', 'GQSDaemon:Deploy a new version of POD containing it', 'AHP, CMD, SRO','2 - High Attention','Deploy a new version of POD', 'Open', date)
    Story.CreateHistoryFromExcel('SRMF-107', 'UniqueDaemon:Deploy a new version of POD', '','2 - High Attention','Deploy a new version of POD', 'R3 Validated', date)
    Story.CreateHistoryFromExcel('SRMF-108', 'Logserver POD:Deploy a new version of POD', 'AHP, CMD, SRO','2 - High Attention','Deploy a new version of POD', 'Open', date)
    Story.CreateHistoryFromExcel('SRMF-109', 'AcsServer:Deploy a new version of POD', 'CMD, SRO','2 - High Attention','Deploy a new version of POD', 'Open', date)
    Story.CreateHistoryFromExcel('SRMF-110', 'GQS:Deploy a new version of POD', 'AHP, CMD, SRO','2 - High Attention','Deploy a new version of POD', 'Open', date)
    Story.CreateHistoryFromExcel('SRMF-111', 'G-ESB:Deploy a new version of POD', 'AHP, CMD, SRO','2 - High Attention','Deploy a new version of POD', 'Open', date)
    Story.CreateHistoryFromExcel('SRMF-113', 'ServiceRegistery:Create a new POD', '','2 - High Attention','Create a new POD', 'R3 Validated', date)
    Story.CreateHistoryFromExcel('SRMF-114', 'ServiceRegistery:Create the POD with several instances', '','2 - High Attention','Create a new POD', 'R3 Validated', date)
    ...
    Story.CreateHistoryFromExcel('SRMF-120', 'FDF:Create an instance of a new POD', 'AHP, CMD, SRO','2 - High Attention','Create a new POD', 'Blocked', date)
    Story.CreateHistoryFromExcel('SRMF-121', 'FDF:Create several instances of a POD containing it', 'AHP, CMD, SRO','2 - High Attention','Create a new POD', 'Blocked', date)
    Story.CreateHistoryFromExcel('SRMF-123', 'ServiceRegistery:Deploy a new version of POD', 'CMD, SRO','2 - High Attention','Deploy a new version of POD', 'Open', date)
    Story.CreateHistoryFromExcel('SRMF-124', 'Addition of a new set of machines into a CouchBase cluster', 'CMD, DataStore','4 - Low','Modify size of Couchbase environment', 'Open', date)
    Story.CreateHistoryFromExcel('SRMF-125', 'Deletion of an existing set of machines from a CouchBase cluster', 'CMD, DataStore','4 - Low','Modify size of Couchbase environment', 'Open', date)
    Story.CreateHistoryFromExcel('SRMF-126', 'Activate a new version of CouchBase', 'CMD, DataStore','4 - Low','Apply and fallback Couchbase releases', 'Open', date)
    Story.CreateHistoryFromExcel('SRMF-127', 'Fallback an existing version of CouchBase', 'CMD, DataStore','4 - Low','Apply and fallback Couchbase releases', 'Open', date)
    Epic.CreateEpicFromExcel('SRMF-128', 'Apply and fallback Couchbase releases', 'ACS_1.2')
    Epic.CreateEpicFromExcel('SRMF-129', 'Modify size of Couchbase environment', 'ACS_1.2')
    ...
    Story.CreateHistoryFromExcel('SRMF-142', 'Target proper \'master\' files for FDF depending on environment', 'CMD, SRO','2 - High Attention','Have a proper way to manage configuration specific to a given system', 'Open', date)
    ...
    Story.CreateHistoryFromExcel('SRMF-157', 'FDF:Deploy a new version of POD', 'AHP, CMD, SRO','2 - High Attention','Deploy a new version of POD', 'Open', date)
    ...
    Story.CreateHistoryFromExcel('SRMF-160', 'APA:Deploy a new version of POD', 'AHP, CMD, SRO','2 - High Attention','Deploy a new version of POD', 'Open', date)
    Story.CreateHistoryFromExcel('SRMF-162', 'APA:Create the POD with several instances', '','2 - High Attention','Create a new POD', 'Partially Validated', date)
    Story.CreateHistoryFromExcel('SRMF-163', 'APA:Create an instance of a new POD', '','2 - High Attention','Create a new POD', 'Partially Validated', date)
    Story.CreateHistoryFromExcel('SRMF-164', 'Dismantle an Isolation Zone (DUM OBE)', '','2 - High Attention','Dismantle an existing Izolation Zone', 'R3 Validated', date)
    ...
    Story.CreateHistoryFromExcel('SRMF-188', 'Bad Blueprint : Invalid json format', '','3 - Normal','Create a new POD', 'R3 Validated', date)
    Story.CreateHistoryFromExcel('SRMF-189', 'Bad Blueprint : Missing mandatory parameter in blueprint', 'SRO','3 - Normal','Create a new POD', 'In Progress', date)
    Story.CreateHistoryFromExcel('SRMF-190', 'Bad Blueprint : Bad data types in blueprint', '','3 - Normal','Create a new POD', 'R3 Validated', date)
    Story.CreateHistoryFromExcel('SRMF-191', 'Bad Blueprint : Inconsistencies between POD/Service blueprints of a given component', 'SRO','3 - Normal','Create a new POD', 'Open', date)
    ...
    Story.CreateHistoryFromExcel('SRMF-396', 'Destructive test/monkey testing', 'DevEx','3 - Normal','AHP:Global Integration on ACS', 'Open', date)
    ...
    Epic.CreateEpicFromExcel('SRMF-428', 'Suspend traffic to a Silo', 'ACS_1.1')
    Epic.CreateEpicFromExcel('SRMF-429', 'Resume the traffic to a Silo', 'ACS_1.1')
    ...
    Story.CreateHistoryFromExcel('SRMF-464', 'Alert on SLA failures', '','3 - Normal','Alerting on environment issues', 'Reopened', date)
    ...
    Story.CreateHistoryFromExcel('SRMF-474', 'Alert on inbound traffic per environment', '','3 - Normal','Alerting on environment issues', 'Out of R3 Scope', date)
    Story.CreateHistoryFromExcel('SRMF-475', 'Alert on outbound traffic per environment', '','3 - Normal','Alerting on environment issues', 'Out of R3 Scope', date)
    ...
    Story.CreateHistoryFromExcel('SRMF-479', 'Alert on Couchbase backup failures', 'DataStore, MNR','3 - Normal','Alerting on environment issues', 'Open', date)
    ...
    Story.CreateHistoryFromExcel('SRMF-486', 'DML is applied - Success', 'SRE','3 - Normal','Apply an online data change (DML) on Oracle', 'Open', date)
    Story.CreateHistoryFromExcel('SRMF-487', 'DML is applied - Failure', 'SRE','3 - Normal','Apply an online data change (DML) on Oracle', 'Open', date)
    Story.CreateHistoryFromExcel('SRMF-488', 'DML is fallen back - Success', 'SRE','3 - Normal','Fallback an online data change (DML) on Oracle', 'Open', date)
    Story.CreateHistoryFromExcel('SRMF-489', 'DML is fallen back - failure', 'SRE','3 - Normal','Fallback an online data change (DML) on Oracle', 'Open', date)
    ...
    Story.CreateHistoryFromExcel('SRMF-496', 'Suspend traffic to a POD - Success', 'SRO','2 - High Attention','Suspend traffic to a Silo', 'Open', date)
    Story.CreateHistoryFromExcel('SRMF-497', 'Suspend traffic to a POD - Failure', 'SRO','2 - High Attention','Suspend traffic to a Silo', 'Open', date)
    Story.CreateHistoryFromExcel('SRMF-498', 'SW Load Fallback - Resume traffic to a POD - Success', 'SRO','2 - High Attention','Resume the traffic to a Silo', 'Open', date)
    Story.CreateHistoryFromExcel('SRMF-499', 'SW Load Fallback - Resume traffic to a POD - Failure', 'SRO','2 - High Attention','Resume the traffic to a Silo', 'Open', date)
    ...
    Story.CreateHistoryFromExcel('SRMF-511', 'Remove document view on Couchbase - Success', 'DataStore','3 - Normal','Removing an existing view document from CouchBase', 'Open', date)
    Story.CreateHistoryFromExcel('SRMF-512', 'Remove document view on Couchbase - Failure', 'DataStore','3 - Normal','Removing an existing view document from CouchBase', 'Open', date)
    ...
    Story.CreateHistoryFromExcel('SRMF-526', 'Alerting configuration', 'MNR','2 - High Attention','Capability to configure the framework', 'Open', date)
    ...
    Story.CreateHistoryFromExcel('SRMF-530', 'Apply NW changes - Success', 'CMD','3 - Normal','Apply and fallback bootstrap releases', 'Open', date)
    Story.CreateHistoryFromExcel('SRMF-531', 'Apply NW changes - Failure', 'CMD','3 - Normal','Apply and fallback bootstrap releases', 'Open', date)
    Story.CreateHistoryFromExcel('SRMF-532', 'Apply Security Groups changes - Success', 'CMD','3 - Normal','Apply and fallback bootstrap releases', 'Open', date)
    Story.CreateHistoryFromExcel('SRMF-533', 'Apply Security Groups changes - Failure', 'CMD','3 - Normal','Apply and fallback bootstrap releases', 'Open', date)
    ...
    Story.CreateHistoryFromExcel('SRMF-536', 'Apply Routers changes - Success', 'CMD','3 - Normal','Apply and fallback bootstrap releases', 'Open', date)
    Story.CreateHistoryFromExcel('SRMF-537', 'Apply Routeurs changes - Failure', 'CMD','3 - Normal','Apply and fallback bootstrap releases', 'Open', date)
    ...
    Story.CreateHistoryFromExcel('SRMF-540', 'Apply user keys changes - Success', 'CMD','3 - Normal','Apply and fallback bootstrap releases', 'Open', date)
    Story.CreateHistoryFromExcel('SRMF-541', 'Apply user keys changes - Failure', 'CMD','3 - Normal','Apply and fallback bootstrap releases', 'Open', date)
    ...
    Story.CreateHistoryFromExcel('SRMF-558', 'Consul load a new version - success', 'SRO','3 - Normal','Deploy a new version of POD', 'Open', date)
    Story.CreateHistoryFromExcel('SRMF-559', 'Consul load a new version - failure', 'SRO','3 - Normal','Deploy a new version of POD', 'Open', date)
    ...
    Story.CreateHistoryFromExcel('SRMF-562', 'acs_server/acs_client load a new version - success', 'SRO','2 - High Attention','Deploy a new version of POD', 'Open', date)
    Story.CreateHistoryFromExcel('SRMF-563', 'acs_server/acs_client load a new version - failure', 'SRO','2 - High Attention','Deploy a new version of POD', 'Open', date)
    Story.CreateHistoryFromExcel('SRMF-564', 'acs_server/acs_client version fallback - success', 'SRO','2 - High Attention','Deploy a new version of POD', 'Open', date)
    Story.CreateHistoryFromExcel('SRMF-565', 'acs_server/acs_client version fallback - failure', 'SRO','2 - High Attention','Deploy a new version of POD', 'Open', date)
    ...
    Story.CreateHistoryFromExcel('SRMF-568', 'Consul version fallback - success', 'SRO','3 - Normal','Deploy a new version of POD', 'Open', date)
    Story.CreateHistoryFromExcel('SRMF-569', 'Consul version fallback - failure', 'SRO','3 - Normal','Deploy a new version of POD', 'Open', date)
    ...
    Story.CreateHistoryFromExcel('SRMF-606', 'Consul scaling up - success', '','3 - Normal','Create a new POD', 'R3 Validated', date)
    Story.CreateHistoryFromExcel('SRMF-607', 'Consul scaling up - failure', 'SRO','3 - Normal','Create a new POD', 'Open', date)
    ...
    Story.CreateHistoryFromExcel('SRMF-662', 'Monitor number of items in queue (DB)', 'Queues','3 - Normal','Check the health status of functional queues (LQS/GQS)', 'Open', date)
    Epic.CreateEpicFromExcel('SRMF-663', 'Isolate/Resume traffic on a RU', 'ACS_1.1')
    Story.CreateHistoryFromExcel('SRMF-664', 'SW Load Fallback - Check the isolation of the RU is working (no more traffic on it)', '','2 - High Attention','Isolate/Resume traffic on a RU', 'Open', date)
    Story.CreateHistoryFromExcel('SRMF-665', 'SW Load Fallback - Check the isolation of the RU is working (no more traffic on it) - failure', '','2 - High Attention','Isolate/Resume traffic on a RU', 'Open', date)
    Story.CreateHistoryFromExcel('SRMF-666', 'SW Load Fallback - Check the RU is taking traffic again on resume', '','2 - High Attention','Isolate/Resume traffic on a RU', 'Open', date)
    Story.CreateHistoryFromExcel('SRMF-667', 'SW Load Fallback - Check the RU is taking traffic again - failure scenario (consistent state even if on action failure)', '','2 - High Attention','Isolate/Resume traffic on a RU', 'Open', date)


class Migration(migrations.Migration):

    dependencies = [
        ('story', '0027_story_priority'),
    ]
