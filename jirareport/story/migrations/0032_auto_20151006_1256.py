...
def import_history(apps, schema_editor):
    date = datetime.strptime("2015-10-05", "%Y-%m-%d")
    ...
    Story.CreateHistoryFromExcel('SRMF-457', 'Test detection of heap dumps', 'MNR','4 - Low','Alerting on environment issues', 'Open', date)
